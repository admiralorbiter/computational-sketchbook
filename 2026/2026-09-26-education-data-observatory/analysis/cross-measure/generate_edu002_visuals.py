...
ax.set_title('[DESCRIPTIVE OBSERVATION] The Central Aggregation Discrepancy: Where Are the Students?\nTop Kansas City Districts Where LEA Membership Exceeds the Sum of Physical School Rosters (SY 2024–25)', fontsize=10.5, fontweight='bold', pad=15)
ax.set_xlim(0, 850)

footer_text5 = (
    "CLASSIFICATION: DESCRIPTIVE OBSERVATION. Source: NCES CCD LEA Survey vs. School Universe Survey (SY 2024–25).\n"
    "Discrepancies occur when students are placed in out-of-district day schools, homebound programs, or central administrative rolls without a building code.\n"
...
# 11-Year Longitudinal Trajectory: The 2020 COVID Drop & Stagnation
# -------------------------------------------------------------
fig, ax = plt.subplots(figsize=(10, 5.2), dpi=300)
...
ax.annotate(f"COVID-19 Drop: {drop:,.0f} students (-2.2%)\nPost-pandemic enrollment stagnates at ~320k",
