...
def generate_four_pillar_framework():
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write("   - *Metric:* Departmentalized secondary teachers log every separate class section (up to 10), recording subject, grade level, and exact student headcount.\n")
        ...
        f.write("   - *Core Finding:* Actual departmentalized high school class sizes were **stable through the pre-pandemic decade** (Missouri: 21.8 in 2011–12 to 22.5 in 2017–18; Kansas: 19.7 to 19.8), demonstrating that macro staffing additions did not mechanically shrink high school sections.\n\n")
        ...
        f.write("| **2020–21 (NTPS)\*** | United States | **21.0** | 15.4:1 | **+5.6 students** | Pandemic Year (NCES Category Revisions) |\n")
        f.write("| | Missouri | **19.2** | 13.7:1 | **+5.5 students** | (Table ntps2021_sflt07_t1s) |\n")
        f.write("| | Kansas | **17.4** | 14.1:1 | **+3.3 students** | (Table ntps2021_sflt07_t1s) |\n\n")
