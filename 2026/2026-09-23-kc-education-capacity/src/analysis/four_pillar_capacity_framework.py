...
def generate_four_pillar_framework():
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        ...
        f.write("1. **Distinct Statistics Rather than Divergence:** Between 2011–12 and 2017–18, teacher-reported high-school class sizes remained essentially unchanged in Missouri (21.8 to 22.5) and Kansas (19.7 to 19.8). Statewide all-grade PTRs also showed little improvement (MO 13.8 to 14.1; KS 13.0 to 14.2), reinforcing that these are distinct measures rather than demonstrating a staffing/class-size divergence during this particular window. The material expansion in teacher staffing density occurred in the KC metro panel over the 2014–15 to 2024–25 decade.\n\n")
