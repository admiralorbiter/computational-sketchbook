...
1. **Did KCPS add teachers faster than identified student need grew?**
   ...
   - **Finding:** KCPS aggressively expanded certified teacher staffing relative to enrollment (+21.7% teacher density growth), outstripping its special education accommodation rate and reaching 84.2 teacher FTE per 1,000 students (11.88 students per teacher FTE).
...
3. **Did KCKPS?**
   ...
   - **Finding:** While regional peers added +6 to +11 teachers per 1,000 students (e.g. Grandview +10.7, Blue Valley +10.3, SMSD +9.2, NKC +6.8), KCKPS experienced acute capacity stagnation and erosion, leaving it severely strained under massive EL and SPED loads.

4. **Did suburban districts respond differently?**
   - **YES. Suburban districts expanded teacher density while accommodation rates rose (with Shawnee Mission specifically documenting the planning-time schedule transition):**
     ...
     - **Blue Valley:** Added **+10.3 teachers per 1,000 (+15.6%)**, reducing PTR from 15.13:1 to 13.09:1 (-2.04), while Section 504 rose from 2.32% to 3.24%.
     - **North Kansas City:** Added **+6.8 teachers per 1,000 (+10.7%)**, driving PTR from 15.73:1 to 14.21:1 (-1.52), while accommodations rose from 14.23% to 19.93% (+5.70 pp).
     - **Lee's Summit:** Added **+2.3 teachers per 1,000 (+3.6%)**, driving PTR down from 15.24:1 to 14.71:1 (-0.53), while accommodations rose from 12.44% to 17.31% (+4.87 pp).

5. **Which districts saw falling students-per-FTE but rising SPED/504 burden?**
   - **Almost the entire region!** Across the 56 eligible longitudinal districts (LEAs with baseline enrollment ≥ 400 present across both endpoints), **48 districts (85.7% of the eligible sample)** saw students-per-teacher FTE fall (improved headline staffing) while their student accommodation share increased.
...
![Figure 16: District Staffing vs. Accommodations Over Time](../figures/fig16_district_capacity_vs_need_trajectories.png)

### Figure 17: Quadrant Scatter Plot (Staffing Expansion vs. Need Growth)
![Figure 17: Staffing Expansion vs. Need Growth Quadrants](../figures/fig17_district_growth_scatter_capacity_vs_need.png)
