...
* **Decision:** Insert **Phase 3C (Staffing Integrity & Allocation Audit)** prior to Phase 4. Phase 3C establishes three empirical workstreams:
  1. **Independent State Replication:** Replicate teacher FTE counts district-by-district between NCES CCD and state administrative databases—KSDE Superintendent's Organization Report (SO66) / Licensed Personnel Reports (LPR) and MO DESE Core Data / MOSIS workforce files—for three anchor years (2014–15, 2019–20, and 2024–25) to verify whether the $+1,922$ FTE expansion is independently confirmed.
  2. **Staffing Role & Need Decomposition:** Ingest and decompose specialized instructional categories: Special Education teacher FTE, SPED paraprofessionals, IDEA enrollment, English Learner (EL) enrollment, Title III/bilingual teachers, and non-teaching support staff (instructional coordinators, counselors, psychologists, social workers). Determine how much of the aggregate teacher growth tracked specialized student needs versus general instructional capacity.
  3. **Federal Triangulation & Benchmarking:** Benchmark the allocation wedge against the Civil Rights Data Collection (CRDC across 6 survey waves: 2013–14, 2015–16, 2017–18, 2020–21, 2021–22, 2023–24) and the National Teacher and Principal Survey (NTPS state departmentalized secondary class size estimates).
  Subsequently split Phase 4 into **Phase 4A** (Actual Section & Roster Distributions, Student-Weighted Exposure, Teacher Roster Load, and Allocation Diagnostics) and **Phase 4B** (Classroom Complexity Overlay: IEP, ELL, chronic absenteeism, and student mobility at the section level).
