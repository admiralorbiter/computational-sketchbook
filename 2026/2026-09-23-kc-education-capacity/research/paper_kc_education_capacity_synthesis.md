...
```
   ...
   --> The lived constraint: Roster headcounts are flat to lower (122–147), but 16.4% of students
       require legal accommodations and 24.69% are chronically absent (latest 2022–23 public release),
...
* **The Wyandotte Staffing Disconnect:** Wyandotte High School is one of the rare urban campuses with a public website explicitly disaggregating faculty by department, currently listing **8 Math Teachers**. In 2023–24, CRDC reported **121 math classes and 2,351 student enrollments**. Dividing CRDC quantities by the 8 listed teachers yields **15.1 classes and 293.9 enrollments per teacher**—an impossible concurrent assignment under a 6-block schedule (8 teachers can instruct at most 48 concurrent sections). The mismatch is consistent with one or more of the following: cumulative block/semester reporting, incomplete or differently classified math staff, and temporal differences between the CRDC year and current website:
  1. *Cumulative Block / Semester Reporting:* Under OCR reporting rules, block-schedule schools may report the cumulative sum of fall and spring semester classes (~60 concurrent sections per semester requiring ~10 full-time teachers).
  2. *Incomplete or Differently Classified Math Staff:* Teachers who instruct math sections are often categorized under Special Education (co-teachers), ESOL/Bilingual education, or instructional coaching rather than "Math Teachers".
  3. *Temporal Differences & Vacancy Lag:* Current web directories reflect 2024–2026 staffing and omit vacancies, long-term substitutes, or adjuncts that existed during the 2023–24 CRDC collection wave.
...
**The Analytical Boundary:** This audit establishes the practical boundary in the public artifacts audited. Rather than a definitive barrier inherent to state administration, this boundary reflects the format of public dissemination: Kansas and Missouri state educational agencies collect richer assignment-level data internally (KSDE's Educator Data Collection System [EDCS] / Licensed Personnel Report [LPR] records subject assignments and requires districts to enter class counts; Missouri DESE's MOSIS / Core Data collects educator assignment Screen 18, course assignment Screen 20, and student assignment files), but these data are generally released publicly only in aggregate forms. (KSDE's dynamic public Educator Directory Reports system stands as an unverified possible exception that may expose assignment queries, though its coverage, grain, and systematic usability remain unverified without a dedicated data pull). Within the public web and federal artifacts audited, empirical capability terminates at Step 3 (Modeled Course-Load Scenarios). Calculating true department-level student-course loads ($E_{\text{dept}} / T_{\text{dept}}$), individual teacher rosters, or section-level variance requires restricted-use state educator microdata or internal district master schedules.
...
3. **The Chronic Absenteeism Plateau:** Prior to the pandemic, regional chronic absenteeism (defined as missing $\ge 10\%$ of school days) stood at **12.90%** (2017–18). During the 2020–21 pandemic disruption, chronic absenteeism spiked to **35.14%**. Rather than receding to pre-pandemic baselines, regional absenteeism settled into a persistent post-pandemic plateau at **24.68% in 2021–22 and 24.69% in 2022–23** (the latest publicly released federal EDFacts FS195 analytical data file)—an increase of **+11.79 percentage points above baseline**. (Public analytical reporting under EDFacts currently concludes with SY 2022–23; SY 2023–24 public analytical files have not been released).

While building-level average daily attendance often remains in the 90–92% range, chronic absenteeism compounds instructional friction across the school year. Because nearly one in four students misses at least 10% of instructional time (at least 17–18 school days per year), secondary teachers face continuous asynchronous re-teaching. A teacher managing 125 to 147 students across a schedule cycle is actively coordinating curriculum continuity, digital gradebook remediation, makeup laboratories and exams, and family communication for 30 to 36 chronically absent students who miss instruction in non-synchronized intervals throughout the year.
...
A central contribution of this investigation is documenting the practical boundary in the public artifacts audited, and distinguishing where ordinary public administrative data end and where restricted microdata begin.
