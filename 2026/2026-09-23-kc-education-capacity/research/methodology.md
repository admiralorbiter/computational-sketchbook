...
3. **Phase 3: Longitudinal Capacity Panel (Task 003A & 003B)**
   * **Task 003A & 003A.1: Construction, Exception Remediation & Audit Foundation (11 School Years, 10-Year Interval):**
     ...
     * **Resolution of 2015–16 Kansas Suppression:** In 2015–16, Olathe (2010140) and Gardner Edgerton (2006420) had staff counts suppressed (`-9.0`) in federal CCD data. Remediated to `NaN`. On reporting Kansas LEAs, the K–12 student/teacher ratio is 15.03 (smooth with 14.96 in 2014–15 and 14.77 in 2016–17), proving the uncorrected 20.02 spike was an artifact of unhandled NCES suppression.
   ...
   * **Task 003B: Longitudinal Structural Capacity Analysis:**
     * Scope: Narrower than full hypothesis testing. Directly investigates: *How has structural staffing capacity changed across the Kansas City region over the past decade?*
     * Examines structural pupil/teacher and adult capacity ratios across urban core, suburban ring, and rural strata.
     * Methodological Boundary: The longitudinal CCD panel measures structural staffing ratios, not classroom sections or student rosters. It cannot directly test H1a, H1b, or H3 (which require section-level class rosters), nor H2 (which requires longitudinal IDEA/ELL/attendance data).
