...
- **Decision 035 & Reference Guide:** Codified the 26-year institutional arc of *Jenkins v. Missouri* (1977–2003), the Resource Conversion Funnel, cost taxonomy, and five cross-domain capacity models in [`research/jenkins_history_and_resource_conversion_framework.md`](research/jenkins_history_and_resource_conversion_framework.md).
- **Decision 036 (The Four-Pillar Measurement Framework):** Formalized the parallel tracking of Structural Staffing Density (CCD) alongside Actual Teacher-Reported Class Size (SASS/NTPS), integrated with Jenkins historical daily contact loads and CRDC course-level proxies. Confirmed the core empirical contrast: *Teacher staffing density improved substantially (+9.8% to +22%); actual class sizes fell much less.*
